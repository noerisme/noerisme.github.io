;(function (window) {
  ...
  let texts = ['HAI WAWOL', 'OJO LALI', 'BAHAGIA', 'OJO LALI', 'NGGUYU', 'KUDU BAHAGIA', 'GA BOLE', 'NANGIS', 'WES GEDE', 'OKE NGUNU AE', 'BYE', '-AZHAR']
  ...
  function playAudio() { 
    var x = document.getElementById("iframeAudio"); 
    x.play(); 
  }
